const { telegramSchema } = require("../../schema/user/telegramSchema");
const jwt = require("jsonwebtoken");
const { changeOption } = require("../../services/userService");
const { JWT_SECRET } = process.env;

const changeTelegramController = async (req, res, next) => {
  const { error } = telegramSchema.validate(req.body);
...
module.exports = changeTelegramController;
