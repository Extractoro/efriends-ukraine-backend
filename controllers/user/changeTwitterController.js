const { twitterSchema } = require("../../schema/user/twitterSchema");
const jwt = require("jsonwebtoken");
const { changeOption } = require("../../services/userService");
const { JWT_SECRET } = process.env;

const changeTwitterController = async (req, res, next) => {
  const { error } = twitterSchema.validate(req.body);
...
module.exports = changeTwitterController;
