const { githubSchema } = require("../../schema/user/githubSchema");
const jwt = require("jsonwebtoken");
const { changeOption } = require("../../services/userService");
const { JWT_SECRET } = process.env;

const changeGithubController = async (req, res, next) => {
  const { error } = githubSchema.validate(req.body);
...
module.exports = changeGithubController;
