const { facebookSchema } = require("../../schema/user/facebookSchema");
const jwt = require("jsonwebtoken");
const { changeOption } = require("../../services/userService");
const { JWT_SECRET } = process.env;

const changeFacebookController = async (req, res, next) => {
  const { error } = facebookSchema.validate(req.body);
...
module.exports = changeFacebookController;
