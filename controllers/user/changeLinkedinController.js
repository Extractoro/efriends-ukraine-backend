const { linkedinSchema } = require("../../schema/user/linkedinSchema");
const jwt = require("jsonwebtoken");
const { changeOption } = require("../../services/userService");
const { JWT_SECRET } = process.env;

const changeLinkedinController = async (req, res, next) => {
  const { error } = linkedinSchema.validate(req.body);
...
module.exports = changeLinkedinController;
